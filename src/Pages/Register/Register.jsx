...
const Register = () => {
  ...
  return (
    ...
    <h2 className="text-4xl font-bold my-4 mb-6">Sign up  </h2>
        ...
        <input name='name' id="name" type="text" placeholder="Full name" className="placeholder:text-gray-500 placeholder:font-normal border-zinc-300 dark:border-zinc-700 focus-visible:outline-zinc-500 border focus-visible:outline-2 focus-visible:outline dark:focus-visible:outline-zinc-500 focus-visible:border-transparent py-2 px-3 rounded bg-transparent" />
    </div>
    <div className="grid gap-1 w-full dark:text-gray-200">
    ...
    <div className="grid gap-1 w-full dark:text-gray-200">
        ...
        <input name='photo' id="text" type="text" placeholder="Password" className="placeholder:text-gray-500 placeholder:font-normal border-zinc-300 dark:border-zinc-700 focus-visible:outline-zinc-500 border focus-visible:outline-2 focus-visible:outline dark:focus-visible:outline-zinc-500 focus-visible:border-transparent py-2 px-3 rounded bg-transparent" />
    </div>
    <button className="bg-zinc-800 dark:bg-zinc-50 text-white w-full mx-auto font-semibold dark:text-black mt-2 hover:border-black focus-visible:outline-black/50 px-6 py-2 rounded-md border-[1.5px] border-transparent transition-colors duration-100 focus-visible:outline active:scale-[0.99]">
        Create account
    </button>
   </form>
