		...
		<div className="flex  flex-col space-y-1">
          ...
          <div className="space-x-2">
			...
			<button aria-label="Bookmark this post" type="button" className="p-2">
				...
				<div>
					<h2 className='mb-3 text-xl font-semibold text-start'>{ title}</h2>
		<img src={image_url} alt="" className="object-cover w-full mb-4 h-60 sm:h-96 dark:bg-gray-500" />
		
					<p className="text-sm text-start dark:text-gray-400 "> {details.slice(0,150)} ...</p>
					<p  className=' font-semibold text-start text-yellow-600'>
  ...
  <input type="radio" name="rating-2" className="mask mask-star-2 bg-orange-400" />
          ...
          <div className="flex items-center space-x-2 text-sm dark:text-gray-400">
            <div className='flex items-center gap-1'>
              <FaEye className='dark:text-violet-400 w-4 h-4' />
								<p>{total_view}</p>
            </div>
